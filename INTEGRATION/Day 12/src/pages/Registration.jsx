                ...
                <div className="card-container">
                    <div className="card-left">
                        <div className="card-body">
                            <h5 className="card-title" style={{ fontFamily: 'cursive' }}>Welcome !!</h5>
                            <p className="card-text" style={{ fontFamily: 'cursive' }}> Create an Account and Book Your Boat House</p>
                        </div>
                    </div>
                    <div className="separator-line"></div>
                    <div className="card-right">
                        <h2 style={{ textAlign: 'center', fontFamily: 'cursive' }}>Create an Account</h2>
