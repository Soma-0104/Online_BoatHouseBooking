                        ...
                        <div className="col-lg-12">
                            <div className="section_title_all text-center">
                                <h3 className="font-weight-bold">
                                    Welcome to our <span className="text-custom">AquaMarina Boat House Booking!</span>
                                </h3>
                            ...
                            <div className="about_header_main mt-3">
                                {editMode ? (
                                    ...
                                    <>
                                        ...
                                        <p className="text-muted mt-3">{editableContent}</p>
                                        <h4 className="about_heading text-capitalize font-weight-bold mt-4">Get In Touch</h4>

                                        <p className="text-muted mt-3">
                                            Ready to embark on your next boating journey? Start exploring our collection of boat houses today! For inquiries or assistance, feel free to reach out to our friendly team at <Link to='/Contact'>Contact</Link>.
                                        </p>
