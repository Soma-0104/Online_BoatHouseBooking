...
public class BoatController {
    ...
    @GetMapping("/boatprice/{price}")
    public Optional<BoatDetails> getByPrice(@PathVariable String price) {
        return service.getByPrice(price);
    }
    @GetMapping("/boattime/{time}")
    public List<BoatDetails> getByTime(@PathVariable String fromTime) {
        return service.getByTime(fromTime);
    }
